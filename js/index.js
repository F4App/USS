...
/*
  ...
  Shape Shifter
  =============
  A canvas experiment by Marvin aka Alt F4
  http://www.kennethcachia.com

  Subscribe me on YouTube:
  ------------
  http:/www.youtube.com/ztzockt
...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Shape|Shifter|U|Schreib etwas|um loszulegen|#rectangle|#countdown 3||');
    }
  ...
  return {
    imageFile: function (url, callback) {
      ...
      image.onerror = function () {
        callback(S.ShapeBuilder.letter('Wie bitte?'));
      }
